...
{
    public partial class ProtocoloLicenciaOperacionRepositorio : IProtocoloLicenciaOperacionRepositorio
    {
        ...
        public IEnumerable<ProtocoloLicenciaOperacionResponse> genera_protocolo_licencia_operacion()
        {
            ...
            var result = from r in _dataContext.p_GENERA_DATA_PROTOCOLO_LICENCIA_OPERACION()
                         select new ProtocoloLicenciaOperacionResponse()
                         {
