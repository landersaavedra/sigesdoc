...
namespace SIGESDOC.Request
{
    ...
    public partial class SolicitudInspeccionRequest
    {
        ...
        public virtual VersionSolicitudRequest version_solicitud { get; set; }
        public virtual List<ActaInspeccionDsfpaRequest> acta_inspeccion_dsfpa { get; set; }
        public virtual List<InformeInspeccionDsfpaRequest> informe_inspeccion_dsfpa { get; set; }
        public virtual List<PruebaInspeccionDsfpaRequest> prueba_inspeccion_dsfpa { get; set; }
        public virtual List<CheckListInspeccionDsfpaRequest> check_list_inspeccion_dsfpa { get; set; }
